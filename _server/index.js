...
io.on('connection', client => {
    ...
    client.on('login', data => {
        ...
        if(verifyUser(data)) {
            ...
            console.warn(`Someone tried to connect with userName ${userName} with id ${data?.id}, but name either didn't exist or didn't have correct ID`)
            client.disconnect();
        }
    })
    ...
    client.on('retrieve-messages', data => {
        ...
        verifyUser(data) ?
            ...
            console.warn(`unknown user tried to receive messages: id ${id}, userName ${userName}`)
    })
